...
/// Composes [SpeechToTextService], [TtsService], and [VoicePrefs] into a single
...
class VoiceController extends ChangeNotifier {
  ...
  VoiceController(this._stt, this._tts, this._prefs);
  ...
  ///
  /// Any ongoing TTS is stopped first. [localeId] defaults to `'es_ES'`.
